...
foreach([['type'=>'arduino','fqbn'=>'esp32:esp32:esp32s3'],['type'=>'esp-idf','idf_target'=>'esp32c6'],['type'=>'platformio','environment'=>'esp32dev']] as $target)$metadata->validateTarget($target);
