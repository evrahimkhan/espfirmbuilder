...
foreach(['mktemp','trap ','--proto \'=https\'','--tlsv1.2','X-CSRF-Token','action=login','api/projects.php','action=logout'] as $needle)if(!str_contains($script,$needle)){fwrite(STDERR,"Synthetic monitor is missing {$needle}.\n");exit(1);}
