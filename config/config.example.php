...
return [
    ...
    'security' => ['encryption_key' => 'replace-with-32-byte-random-secret', 'artifact_signing_key' => 'replace-with-a-distinct-32-byte-random-secret', 'previous_encryption_keys' => [], 'session_name' => 'espforge_session'],
    'github' => ['client_id' => '', 'client_secret' => '', 'webhook_secret' => '', 'redirect_uri' => 'http://localhost:8080/api/auth.php?action=github_callback'],
